...
ETHERSCAN_KEY=...              # Free tier: 5 calls/sec, 100k calls/day
ARBISCAN_KEY=...               # Free tier available
OPTIMISTIC_ETHERSCAN_KEY=...    # Free tier available
BASESCAN_KEY=...                # Free tier available
POLYGONSCAN_KEY=...             # Free tier available
BSCSCAN_KEY=...                 # Optional, for BSC token holders
SNOWTRACE_KEY=...               # Optional, for Avalanche token holders
FTMSCAN_KEY=...                 # Optional, for Fantom token holders
GNOSISSCAN_KEY=...              # Optional, for Gnosis token holders
ETHPLORER_KEY=freekey          # optional, used for holder concentration (Ethereum only)
COVALENT_API_KEY=...            # Optional, fallback for multi-chain token holders
